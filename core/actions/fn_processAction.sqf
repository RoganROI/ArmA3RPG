...
_itemInfo = switch (_type) do {
	...
	case "jetfuel": {["oil_unprocessed","jetfuel",1200,(localize "STR_Process_Oil")];};
	case "diesel": {["oil_unprocessed","diesel",1200,(localize "STR_Process_Oil")];};
	case "gasoline": {["oil_unprocessed","gasoline",1200,(localize "STR_Process_Oil")];};
